...
1. **Add Accuracy + Closeness indices to the Audit step.** Highest value, low effort, algorithm-agnostic. Concrete representativeness number to publish next to seed/hash. Fits the "show the work as reassurance" principle. → tracked as a GitHub issue (filed 2026-06-25).
